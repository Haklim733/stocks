...
class LocalStackLambda:
    ...
    def deploy_lambda(
        *, function_name: str, zip_file_path: str, role: str, env_vars: Dict
    ):
...
class LocalStackIAM:
    ...
    def create_role(*, role_name, policy):
        ...
        try:
            ...
            iam_c.create_role(RoleName=role_name, AssumeRolePolicyDocument=policy)
